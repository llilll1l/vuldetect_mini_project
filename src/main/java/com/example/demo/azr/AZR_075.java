...
@Getter
@Setter
public class  AZR_075 implements AZR_Scanner{
    ...
    public void allCommand() {
        ...
        setDescription("정책 할당 (삭제) 이벤트 작업로그 경고 설정");
        setCategory("Monitoring");

        /*
        az monitor activity-log alert list
        --resource-group kisia-astron
        --query "[?condition.allOf[?equals == 'Microsoft.Authorization/policyAssignments/delete']]"
         */
        ...
        //실행안됨
        //commandAndArgs.add("--query");
        //commandAndArgs.add("[?condition.allOf[?equals == 'Microsoft.Authorization/policyAssignments/delete']]");

        //점검 방법: az resource show --ids /subscriptions/65a2081f-ab92-4edc-84cd-1db788b315eb/resourceGroups/kisia-astron/providers/microsoft.insights/activitylogalerts/AZR_075 --query properties.enabled
        //az resource update --ids  "/subscriptions/65a2081f-ab92-4edc-84cd-1db788b315eb/resourceGroups/kisia-astron/providers/microsoft.insights/activitylogalerts/AZR_077" --set properties.enabled=true
        //az resource update --ids  "/subscriptions/65a2081f-ab92-4edc-84cd-1db788b315eb/resourceGroups/kisia-astron/providers/microsoft.insights/activitylogalerts/AZR_077" --set properties.enabled=false
        ...
        String equalValue = "Microsoft.Authorization/policyAssignments/delete";

...
@Getter
@Setter
public class AZR_077 implements AZR_Scanner{
    ...
    public void allCommand() {
        ...
        setDescription("네트워크 보안그룹(삭제) 이벤트 작업로그 경고 설정");
        setCategory("Monitoring");

        /*
        az monitor activity-log alert list
        --resource-group kisia-astron
        --query "[?condition.allOf[?equals == 'Microsoft.Authorization/networkSecurityGroups/delete']]"

        점검방법: az resource show --ids /subscriptions/65a2081f-ab92-4edc-84cd-1db788b315eb/resourceGroups/kisia-astron/providers/microsoft.insights/activitylogalerts/AZR_077 --query properties.enabled
        보안 설정 방법: az resource update --ids  "/subscriptions/65a2081f-ab92-4edc-84cd-1db788b315eb/resourceGroups/kisia-astron/providers/microsoft.insights/activitylogalerts/AZR_077" --set properties.enabled=false
        바꿔보기
         */
        ...
        String equalValue = "Microsoft.ClassicNetwork/networkSecurityGroups/delete";
